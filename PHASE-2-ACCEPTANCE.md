...
5. Stop the proxy and observe an explicit failure without direct fallback; restart it and confirm recovery. Disable Network and confirm Core and Local Toolbox still work. Confirm no Media file, Regex edit or persistent proxy URL was created.
